...
// --------------------------------------------------------------------
// true_divide(SparseTensor, Scalar), alias for sparse division
// --------------------------------------------------------------------
...
Tensor& true_divide_sparse_(Tensor& self, const Tensor& divisor) {
  return div_out_sparse_zerodim(self, self, divisor);
}
...
SparseTensor& true_divide_out_sparse_scalar(
    ...
    const SparseTensor& dividend,
    Scalar divisor) {
  return div_out_sparse_zerodim(result, dividend, wrapped_scalar_tensor(divisor));
}
